    ...
    <div class="solve" id="solve2-1">
      ...
      <div class="set-routeName">
        ...
        <div class="set-routeName-default">
          <input class="set-routeName-default-input" type="text" placeholder="请填写公交的部分名称" v-model="busName">
        </div>
        <button type = "button"  class = "search-button" @click="getStationByRoutePartialName()"> 查询 </button>
      </div>
