    ...
    <div class="solve" id="solve2-6">
      ...
      <div class="set-routeName">
        ...
        <div class="set-routeName-default">
          <el-autocomplete class="set-routeName-default-input" v-model="stationName261" :fetch-suggestions="querySearch261" @input="searchFullStationName261" placeholder="请填写站点1的名称" :trigger-on-focus="false" @select="handleSelect261"></el-autocomplete>
        </div>
        <div class="set-routeName-default">
          <el-autocomplete  class="set-routeName-default-input"  v-model="stationName262" :fetch-suggestions="querySearch262" @input="searchFullStationName262" placeholder="请填写站点2的名称" :trigger-on-focus="false" @select="handleSelect262"></el-autocomplete>
        </div>
