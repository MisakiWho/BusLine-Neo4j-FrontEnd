  ...
  <div>
    ...
    <div class="solve" id="solve5-2">
      ...
      <div class="set-line">
        ...
        <div class="set-line-default">
          <input class="set-line-default-input" type="text" placeholder="请填写线路id" v-model="lineId">
        </div>
        <button type = "button"  class = "search-button" v-on:click="deleteLine()"> 删除 </button>
      </div>
    ...
    <div class="solve" id="solve5-3">
      ...
      <div class="set-line">
        ...
        <div class="set-line-default">
          <input class="set-line-default-input" type="text" placeholder="请填写线路id" v-model="lineId2">
        </div>
        <div class="set-line-default">
          <input class="set-line-default-input" type="text" placeholder="请填写旧站点id" v-model="oldStationId">
        </div>
        <div class="set-line-default">
          <input class="set-line-default-input" type="text" placeholder="请填写新站点id" v-model="newStationId">
        </div>
        <button type = "button"  class = "search-button" v-on:click="changeLine()"> 更改 </button>
      </div>
      <div style="height:100px; width:80%; background-color: white">
        <el-scrollbar style="height:100%; width: 100%">
