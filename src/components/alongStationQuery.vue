      ...
      <div class="solve" id="solve2-4-1">
        ...
        <div class="set-routeName">
          ...
          <div class="set-routeName-default">
            <input class="set-routeName-default-input" type="text" placeholder="请填写站点1的名称" v-model="stationName241">
          </div>
          <div class="set-routeName-default">
            <input class="set-routeName-default-input" type="text" placeholder="请填写站点2的名称" v-model="stationName242">
          </div>
          <div class="set-routeName-default">
            <input class="set-routeName-default-input" type="text" placeholder="请填写线路的部分名称" v-model="busPartialName">
          </div>
          <button type = "button"  class = "search-button" @click="getBusDirection()"> 线路方向 </button>
          <button type = "button"  class = "search-button" @click="alongStationsBetween()"> 沿途站点 </button>
          <button type = "button"  class = "search-button" @click="timeCost()"> 运行时长 </button>
        </div>
        ...
        <div style="height:300px; width:80%; background-color: white">
          <el-scrollbar style="height:100%; width: 100%">
            ...
            <ul class="result-ul">
              <li class="result-li" v-for="(item,index) in alongStationsBetweenTwoStations" :key="index">
                <StationItem242 class="route-item" :stationInfo="item" :index="index"></StationItem242>
              </li>
            </ul>
